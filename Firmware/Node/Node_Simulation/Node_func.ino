...
{   
    ...
    uplink_data[0] = (uint8_t)(random(17, 40));
    uplink_data[1] = (uint8_t)(random(99));
    uplink_data[2] = (uint8_t)(random(24, 90));
    uplink_data[3] = (uint8_t)(random(99));
    uplink_data[4] = (uint8_t)(random(20, 50));
    uplink_data[5] = (uint8_t)(random(99));
    uplink_data[6] = (uint8_t)(random(30,99));
    uplink_data[7] = (uint8_t)(random(99));
